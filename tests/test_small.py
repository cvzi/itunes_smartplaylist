...
testdata = [
    {
        ...
        "expected" : {
            "output" : "Rating is in the range of 5 to 5 and\nMediaKind is Music\nLimited to 50000 Items selected by least recently added",
    ...
    },
    {
        ...
        "expected" : {
            "output" : "Album is \"The New America\" ",
...

    {
        ...
        "expected" : {
            "output" : "HasArtwork is True and\nHasArtwork is False and\nPurchased is True and\nPurchased is False and\nSortAlbum is \"L.E.S Artistes - EP\"  and\nSortAlbumartist is \"Academy Is...\"  and\nSortComposer is \"Cardigans\"  and\nSortName contains \"abc\"  and\nSortShow starts with \"Fair\"  and\nVideoRating is \"Old\" ",
            "queryTree" : {
                "onlychecked": False,
                "liveupdate": True,
                "tree": {
